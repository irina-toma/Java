...
CREATE TABLE `film` (
  ...
  `language` varchar(3) COLLATE utf8_romanian_ci NOT NULL,
  `rating` int NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `film` VALUES (1,'Avengers','xzy',2000,'EN',10),(2,'Superman','abc',2010,'EN',7),(3,'BD la mare si la munte','bd',1974,'RO',10);
...
-- Dump completed on 2021-03-23 20:46:51
